#if !defined(AFX_MOLLIERCTRL_H__F4C6E288_12F8_42D9_A172_2A56A1839AFC__INCLUDED_)
#define AFX_MOLLIERCTRL_H__F4C6E288_12F8_42D9_A172_2A56A1839AFC__INCLUDED_
...
#define MOLLIERCTRL_CLASSNAME    _T("MFCMollierCtrl")  // Window class name
...
class CMollierCtrl : public CWnd
{
	DECLARE_DYNCREATE(CMollierCtrl)
	// Construction / DeConstrution
public:
	CMollierCtrl();
	BOOL Create(const RECT& rect, CWnd* parent, UINT nID,
		DWORD dwStyle = WS_CHILD | WS_BORDER | WS_TABSTOP | WS_VISIBLE);
	virtual ~CMollierCtrl();
...
#endif // !defined(AFX_MOLLIERCTRL_H__F4C6E288_12F8_42D9_A172_2A56A1839AFC__INCLUDED_)
